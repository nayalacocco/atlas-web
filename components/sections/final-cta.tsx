...
export function FinalCtaSection() {
  return (
    <section id="contacto" className="shell section-gap pb-28">
      <Reveal className="marble-texture rounded-3xl border border-accent-gold/40 bg-gradient-to-br from-panel to-ink p-10 text-center sm:p-16">
        ...
        <div className="mx-auto mt-7 greek-divider" />
